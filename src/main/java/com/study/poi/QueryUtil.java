...
public class QueryUtil {
    ...
    public List<ItemsInHis> getItemsInHis() {
        ...
        return jdbcTemplate.query(sql, new ItemInHisMapper());
    }

    public int updatePrice(String itemId, String price) {
        String sql = "update 收费价目 set 现价 = ?, 执行日期 = to_date('2020-10-01','YYYY-MM-DD') where 收费细目id = ? and (终止日期 > sysdate or 终止日期 is null) and 执行日期 < sysdate";
